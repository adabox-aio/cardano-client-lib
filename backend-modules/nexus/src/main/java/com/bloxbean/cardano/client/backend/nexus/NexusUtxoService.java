...
public class NexusUtxoService implements UtxoService {
    ...
    /**
     * Nexus has no "all utxos" endpoint; page through {@link #getUtxos(String, int, int)} until a short page
     * is returned. Mirrors BFUtxoService.getAllUtxos.
     */
    @Override
    public Result<List<Utxo>> getAllUtxos(String address) throws ApiException {
        ...
        while (true) {
            Result<List<Utxo>> result = getUtxos(address, count, page);
