...
public class NexusAccountService implements AccountService {
    ...
    private AccountInformation toAccountInformation(adlabs.nexus.client.backend.api.account.model.AccountInformation info) {
        ...
        accountInformation.setPoolId(info.getPoolId());
    ...
    // Nexus exposes no received/sent totals per stake account.
    @Override
    public Result<AccountAddressTotal> getAccountAddressTotal(String stakeAddress) throws ApiException {
        throw new UnsupportedOperationException("getAccountAddressTotal not supported by Nexus");
    }
